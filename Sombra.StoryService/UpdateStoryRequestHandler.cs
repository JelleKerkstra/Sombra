...
{
    public class UpdateStoryRequestHandler : AsyncCrudRequestHandler<UpdateStoryRequest, UpdateStoryResponse>
    {
        ...
        public override async Task<UpdateStoryResponse> Handle(UpdateStoryRequest message)
        {
